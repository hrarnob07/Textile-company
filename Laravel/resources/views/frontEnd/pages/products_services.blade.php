...
@section('title','Products and Service')
@section('content')
...
<section class="innerpageBannerWrap" >
  <div class="innerpagebanner">
    <div class="bannerimg" style="background-image: url({{url('upload/ProductsService/'.$ProductsServices->banner)}})">
...
<section class="wrapper">
  <div class="container">
    <div class="productTopconten">
      <div class="wrapper">
        <h2 class="hclass">{{$ProductsServices->heading}}
