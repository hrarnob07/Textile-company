            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-card-center">
                        ...
                        @if(isset($edit))
                        <i class="icon-user-plus"></i> Edit Processes
                        @else
                        <i class="icon-user-plus"></i> Add Processes
                        @endif
                    </h4>
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <form class="form" method="post" 
                              @if(isset($edit))
                              action="{{url('/admin/Processes/update/'.$edit->id)}}"
                              @else
                              action="{{url('/admin/Processes/add/')}}"
                              @endif
                              ...
                              {!! csrf_field() !!}
                               @if(isset($edit)) <input type="hidden" name="eximage" value="<?= $edit->banner; ?>" /> @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                         @if(isset($edit))<img width="30%" class="card-img-top img-fluid" src="{{ URL::asset('upload/Processes/'.$edit->banner) }}">@endif
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $row->id; ?></td>
                                    <td style="width: 400px"><img width="30%" class="card-img-top img-fluid" src="{{ URL::asset('upload/Processes/'.$row->banner) }}"></td>
                                    <td>
                                        <?php
                                            if($row->heading=='0'){
                                    ...
                                    <td>
                                        <a href="{{url('admin/Processes/edit/'.$row->id)}}" title="Edit" class="btn btn-sm btn-outline-info"><i class="icon-pencil22"></i></a>
                                        <a  href="{{url('admin/Processes/delete/'.$row->id)}}" title="Delete" class="btn btn-sm btn-outline-danger"><i class="icon-cross"></i></a>
