...
class ManagementController extends Controller
{
    ...
    {
        $data = Management::all();
        return view('admin.page.management',['data'=>$data]);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.page.management',['edit' => $edit,'data' => $data]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $site = Management::find($id);
        $site->heading = $request->heading;
        $site->banner = $filename;
        $site->description = $request->description;
        $site->save();
        return redirect('admin/management')->with('status', 'Updated Successfully!');
    }
