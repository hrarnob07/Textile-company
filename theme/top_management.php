...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" version="XHTML+RDFa 1.0" dir="ltr" xmlns:og="http://ogp.me/ns#" xmlns:article="http://ogp.me/ns/article#" xmlns:book="http://ogp.me/ns/book#" xmlns:profile="http://ogp.me/ns/profile#" xmlns:video="http://ogp.me/ns/video#" xmlns:product="http://ogp.me/ns/product#" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:dc="http://purl.org/dc/terms/" xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#" xmlns:sioc="http://rdfs.org/sioc/ns#" xmlns:sioct="http://rdfs.org/sioc/types#" xmlns:skos="http://www.w3.org/2004/02/skos/core#" xmlns:xsd="http://www.w3.org/2001/XMLSchema#" prefix="og:http://ogp.me/ns#">
   ...
   <body class="html front not-logged-in no-sidebars page-node page-node- page-node-1 node-type-page home">
         ...
         <div class="content">
            <section class="innerpageBannerWrap" >
              <div class="innerpagebanner">
                <div class="bannerimg" style="background-image: url('images/about_us_team_top.jpg')"></div>
              </div>
            </section>
            <section class="wrapper topslider">
               <div class="wrapper abouticonleft">
                  <h1 style="color: #fff;">Top Management</h1>
                 <strong class="line-probottomr containerWidth" style="background-color: #fff"><em></em> </strong>
                </div>
                <div class="wrapper">
                  <p>
                    The company’s board is comprising of a team of young,energetic ,visionary,qualified ,ethical & experienced directors. <br> 
                  </p>
                </div>
            </section>
            ...
            <div class="leadArvindSlider whoweareLead">
               <div class="lasSlide">
                  <div>
                     ...
                     <div class="laImgwrap" style="background-image: url(images/ceo_img.png)"> </div>
                     <div class="laContenwrap newAjaxLoad">
                        <h3><a href="">RASHID ASHRAF KHAN </a></h3>
                        <h6>(Founder Director & CEO)</h6>
                        The CEO & Founder director , Mr. Raashid Ashraf Khan is young ,energetic & successful leader with multi skills & proven track record in transforming  businesses  into hugely profitable organisations. Widely reputed in the field of textile & apparel.                  
                        <div>
               ...
               <div class="lasSlide">
                  <div>
                     ...
                     <em class="line-ls-bottom"></em>
                     <em class="line-ls-left"></em>
                     <div class="laImgwrap" style="background-image: url(images/wadud.jpg)"> </div>
                     <div class="laContenwrap newAjaxLoad">
                        <h3><a href="">ABDUL WADUD BHUIYAN</a></h3>
                        <h6>(Chairman)</h6>
                        The founder chairman of the board ,mr.Abdul wadud bhuiyan  is young dynamic , humble, successful with strong self drive ,great leadership quality, & possesses high self integrity .                    
                        <div>
                           <a href="" class="btn-animation red">
                              <svg height="100%" width="100%" xmlns="http://www.w3.org/2000/svg">
                                 <rect x="1" stroke="#fff" class="shapelight" height="99%" width="98%" stroke-opacity="0.5"></rect>
               ...
               <div class="lasSlide">
                  <div>
                     ...
                     <em class="line-ls-bottom"></em>
                     <em class="line-ls-left"></em>
                     <div class="laImgwrap" style="background-image: url(images/arefin.jpg)"> </div>
                     <div class="laContenwrap newAjaxLoad">
                        <h3><a href="">MD. SAMSUL AREFIN</a></h3>
                        <h6>(Director )</h6>
                        Md Samsul Arefin is an energetic and passionate businessman in the Garments sector. He has incessantly worked towards the growth of the company. He is credited with streamlining business processes and formulating long-term strategic plan at Angel Textile Composite Mills Ltd.
...
$(function(){
  ...
  var p=$('#contents').responsiveSlides({
