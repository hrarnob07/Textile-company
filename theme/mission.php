         ...
         <div class="content">
            <section class="innerpageBannerWrap" >
              <div class="innerpagebanner">
                <div class="bannerimg" style="background-image: url(images/h-bg.png)">
                  ...
                  <div class="innerbannerpara">
                     <p>
                       Creating organisational culture of pride,innovation,growth & sustainability throughout the supply chain till the end consumer along the line of manufacturing and value creation.
                     </p>
                  </div>
                  <div class="wrapNaviforslider">
                     <a href="./" class="ajax-linkPush prevBtn" title="Vision"></a>        <div class="navPagename">
                      <span></span>
                      <p></p>
                    </div>
                     <a href="index.php" class="ajax-linkPush nextBtn" title="Welcome"></a>      </div>
                </div>
