         ...
         <div class="content">
            ...
            <section class="innerpageBannerWrap" >
              <div class="innerpagebanner">
                <div class="bannerimg" style="background-image: url(images/20180116082414_StudioG2.jpg)">
            ...
            <section class="wrapper">
               <div class="welContent">
                  <div class="row">
                     <div class="col-md-7">
                        <div class="welLeftContent">
                           <div><strong class="line-stockinfo"><i></i></strong></div>
                               <div>
                                  <h1 style="color: #006991; float: right;padding-right: 5%;font-weight: 900 !important">Vision</h1>
                                 <em class="titalbgline" style="width: 75%; "><i></i></em> 
                               </div>  
                             
                            <div class="content">
                               <p>Being 100% sustainable in terms of supply chain, environment, corporate culture,
                                product & service quality, human resources empowerment & customer delight.
                                Sustainable manufacturing and value enriching by continuous innovations and
                                precise executions to delight the clients keeping clients as our core partners.</p>
                            </div>
                        </div>
                     </div>
                     <div class="col-md-5">
                        <div class="welRightContent">
                         <span style="background-image: url(images/Fabrics-1.jpg);"><i class="aos-item" data-aos="slideLeftoverly"></i></span>
                       </div>
                     </div>
                  </div>
          ...
          <section class="wrapper" style="margin-top: -48px;">
              
              <!-- another image -->
               <div class="anotherWelContent">
                <div class="row">
                     <div class="col-md-5">
                <div class="anWelLeftContent">
                  <span style="background-image: url(images/Compare-the-properties-of-different-fabrics-1-1024x675.jpg);"><i class="aos-item" data-aos="slideLeftoverly"></i></span>
                </div>
             </div>
                     <div class="col-md-7">
                <div class="anWelRightContent">
                  <div><strong class="line-AnContent"><i></i></strong></div>
                  <div>
                     <h1 style="color: #fff; padding-left: 4%">Mission</h1>
                    <em class="line-welAnContent" style="width: 70% !important; background: #fff !important"><i></i></em>
                  </div>        
                  <div class="content">
                     <p>Being 100% sustainable in terms of supply chain, environment, corporate culture,
                      product & service quality, human resources empowerment & customer delight.
